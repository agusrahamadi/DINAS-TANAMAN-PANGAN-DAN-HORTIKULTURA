					...
					<div class="page-content">
						<div class="page-header">
							<h1>Data Tanaman </h1>
                                            ...
                                            <h1>
								<a href="?unit=produk_unit&act=input">
                               ...
                               $c = "Rp. " .number_format($ddatagrid['harga_eceran'], 2);
                                ...
                                <tr>
                                     ...
                                     <td style=text-align:center>
                                         <a href=?unit=produk_unit&act=update&kd_tam=$ddatagrid[kd_tam]  class='btn btn-sm btn-warning glyphicon glyphicon-pencil' ></a> 
                                         <a href=?unit=produk_unit&act=delete&kd_tam=$ddatagrid[kd_tam] class='btn btn-sm btn-danger glyphicon glyphicon-trash' onclick='return confirm(\"Yakin Akan Menghapus Data?\")'></a>    
                                     </td>                
                                </tr>
                                ";
                                $no++;

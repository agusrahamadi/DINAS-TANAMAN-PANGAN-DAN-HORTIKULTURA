                               ...
                               $c = "Rp. " .number_format($ddatagrid['harga_eceran'], 2);
                                ...
                                <tr>
                                     ...
                                     <td style=text-align:center>
                                         <a href=?unit=produk_unitp&act=update&kd_tam=$ddatagrid[kd_tam]  class='btn btn-sm btn-warning glyphicon' >Pengajuan Harga</a> 
                                         </td>                
                                </tr>
                                ";
                                $no++;
...
?>
       ...
       <form id="tambah_pro" name="tambah_pro"  class="form-horizontal"  method="post" action="?unit=produk_unitp&act=inputact" enctype="multipart/form-data" >
                  ...
                  <div class="form-group">
                   ...
                   <div class="clearfix form-actions">
                        ...
                        <button type="reset" name="reset" class="btn btn-danger">Reset</button>
                         <button type="button" name="kembali" class="btn btn-info" onclick="window.location='adminmainapp.php?unit=produk_unitp&act=datagrid'">kembali</button>
                         </div>
			</div> 
...
?>
			...
			<div class="main-content">
              ...
              <li>Tanaman</li>
					...
					<div class="page-content">
						...
						<div class="row">
							<div class="col-xs-12">
                        <form id="tambah_pro" class="form-horizontal" name="tambah_pro"  method="post" action="?unit=produk_unitp&act=updateact" enctype="multipart/form-data" >
                  ...
                  <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right" for="nama_tam">Nama Tanaman</label>
                      <div class="col-sm-9">
                       <input class="col-xs-10 col-sm-5"type="text" value="<?php echo  $dupdate['nama_tam'] ?>" name="nama_tam"  readonly="readonly" id="nama_tam" required />
                       </div>
                           </div>
					   ...
					   <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="harga_produsen">Harga Produsen Yang Akan Diajukan</label>
                     <div class="col-sm-9">
					   ...
					   <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="harga_grosir">Harga Grosir Yang Akan Diajukan</label>
                     <div class="col-sm-9">
					   ...
					   <div class="form-group">
                      <label class="col-sm-3 control-label no-padding-right"for="harga_eceran">Harga Eceran Yang Akan Diajukan</label>
                     <div class="col-sm-9">
 ...
 <?php
        ...
        $rupdate = mysqli_query($mysqli,$qupdate);
        header("location:?unit=produk_unitp&act=datagrid");
                break;
